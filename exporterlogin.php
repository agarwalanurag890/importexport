...
<body>
    ...
    <form action="exporterlogin.php" method="post">
        <h3>Exporter Login</h3>

        <label for="username">Name</label>
        <input type="text" placeholder="Enter Your Name: " id="username" name="name">

        <label for="Name">Phone</label>
        <input type="text" placeholder="Enter Your Phone Number: " id="password" name="phone">
        ...
        if(isset($_POST["submit"]))
        {
            ...
            if(count($error)>0)
            {
                ...
                $stmt=$conn->prepare("select * from exporterreg where name=? and phone=?");
